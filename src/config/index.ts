...
const SHOULD_SKIP_VALIDATION = toBoolean(
  process.env.NODESCRAPE_SKIP_ENV_VALIDATION
);

if (SHOULD_SKIP_VALIDATION) {
  console.warn(
    "WARN: NODESCRAPE_SKIP_ENV_VALIDATION is set to true. Env var validations will be skipped."
  );
}

function getRequiredEnvironmentVariable(
  envVarKey: string,
  shouldSkipValidation = SHOULD_SKIP_VALIDATION
): string {
